...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('医療関係者登録画面') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('メール・アドレス') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="belong_to" class="col-md-4 col-form-label text-md-right">{{ __('所属') }}</label>
